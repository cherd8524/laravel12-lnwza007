            ...
            <div class="row px-lg-5">
                <div class="col-12 col-lg-9 mx-auto">
                    ...
                    <div class="row mx-auto px-lg-5 pb-5">
                        @php $listStarted = false; @endphp

                        @foreach($article->content['paragraphs'] as $block)
                            @switch($block['tag'])
                                @case('p')
                                    @if($listStarted)
                                        </ul>
                                    ...
                                    <div class="col-lg-12 my-2 mt-lg-4">
                                        <p class="fs-5 m-0">{{ $block['inner'] }}</p>
                                    </div>
                                    @break
                                ...
                                @case('img')
                                    @if($listStarted)
                                        ...
                                        @php $listStarted = false; @endphp
                                    @endif
                                    <div class="col-lg-12 my-2 mt-lg-4 text-center">
                                        <img src="{{ $block['inner'] }}" class="rounded w-100" alt="image">
                                    </div>
                                    @break
